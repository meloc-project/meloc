...
A specification to build software through declarations. Build Meloc modules just writing them in YAML. Focus on what your module does, not how. No imperative code, no technical types. Only rules, states, and contracts.
