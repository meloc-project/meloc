...
1. The field `doctype`, where it is indicated which version of the specification the module uses
...
In the fields `doctype` and `dependencies`, however, it depends on the stability of the version:
